...
_ℹ️ - Grupo oficial do programador deste bot!_ *tempest
...
function donate() {
    return `
 Agradeço muito pelo suporte, de antemão, doações não são necessarias para mim, o programador da Íris, basta que você cuide bem da Íris e auxilie os usuarios, se você deseja ver ela ficar melhor mais rapidamente, você pode contribuir com qualquer quantia de dinheiro, que é usado para criar comandos que são pagos.
Caso você queira contibuir, o picpay do criador desse bot é @userlucas123, qualquer coisa entre em contato comigo pela github > github.com*KillovSky*iris. ;D ❤️`
}
